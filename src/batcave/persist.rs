...
use crate::batcave::cave::{
    BatCave, CaveBacking, CaveCap, CaveTool, CaveState, CaveType,
...
fn serialize(cave: &BatCave, out: &mut [u8; MANIFEST_SIZE]) {
...
fn deserialize(buf: &[u8; MANIFEST_SIZE], cave: &mut BatCave) -> Result<(), &'static str> {
