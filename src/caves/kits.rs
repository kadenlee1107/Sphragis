// Sphragis — Kits: Pre-built Tool Bundles by Mission Type
//
// When creating a Cave, pick a kit to auto-install all tools for that mission.
// Usage: caves create mylab --kit recon
//
...
/// Apply a kit to a Cave: install all tools + grant all caps.
