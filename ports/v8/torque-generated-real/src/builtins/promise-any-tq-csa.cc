...
TF_BUILTIN(PromiseAny, CodeStubAssembler) {
  ...
  compiler::CodeAssemblerParameterizedLabel<JSAny, Union<JSMessageObject, TheHole>> block12(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  ...
  TNode<Union<JSMessageObject, TheHole>> phi_bb12_8;
  if (block12.is_used()) {
