...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=116&c=1
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=161&c=1
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=165&c=1
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=175&c=1
...
TF_BUILTIN(WasmAllocateZeroedFixedArray, CodeStubAssembler) {
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).FillEntireFixedArrayWithSmiZero(CastIfEnumClass<ElementsKind>(ElementsKind::PACKED_ELEMENTS), TNode<FixedArray>{tmp4}, TNode<IntPtrT>{parameter0});
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=722&c=1
...
TF_BUILTIN(WasmManagedObjectWait, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp3 = TORQUE_CAST(CodeStubAssembler(state_).CallRuntime(Runtime::kWasmManagedObjectWait, tmp0, parameter0, tmp1, tmp2, parameter3)); 
...
TF_BUILTIN(WasmAllocateWaitQueue, CodeStubAssembler) {
  compiler::CodeAssemblerState* state_ = state();  compiler::CodeAssembler ca_(state());
  TNode<WasmStruct> parameter0 = UncheckedParameter<WasmStruct>(Descriptor::kStructValue);
  USE(parameter0);
  TNode<Int32T> parameter1 = UncheckedParameter<Int32T>(Descriptor::kRawFieldOffset);
  USE(parameter1);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
  ...
  if (block0.is_used()) {
    ...
    tmp0 = LoadContextFromFrame_0(state_);
    tmp1 = CodeStubAssembler(state_).SmiFromInt32(TNode<Int32T>{parameter1});
    tmp2 = TORQUE_CAST(CodeStubAssembler(state_).CallRuntime(Runtime::kWasmAllocateWaitQueue, tmp0, parameter0, tmp1)); 
    CodeStubAssembler(state_).Return(parameter0);
  }
}

// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=775&c=1
void UpdateCallRefOrIndirectIC_0(compiler::CodeAssemblerState* state_, TNode<FixedArray> p_vector, TNode<IntPtrT> p_index, TNode<Object> p_target) {
  ...
  if (block71.is_used()) {
    ...
    tmp61 = CodeStubAssembler(state_).TaggedEqual(TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp60}, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{p_target});
  ...
  if (block39.is_used()) {
    ...
    tmp93 = CodeStubAssembler(state_).TaggedEqual(TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp23}, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp92});
  ...
  if (block149.is_used()) {
    ...
    tmp142 = CodeStubAssembler(state_).AllocateFixedArray(CastIfEnumClass<ElementsKind>(ElementsKind::PACKED_ELEMENTS), TNode<IntPtrT>{tmp141}, CastIfEnumClass<CodeStubAssembler::AllocationFlag>(CodeStubAssembler::AllocationFlag::kNone));
  ...
  if (block217.is_used()) {
    ...
    tmp207 = CodeStubAssembler(state_).AllocateFixedArray(CastIfEnumClass<ElementsKind>(ElementsKind::PACKED_ELEMENTS), TNode<IntPtrT>{tmp206}, CastIfEnumClass<CodeStubAssembler::AllocationFlag>(CodeStubAssembler::AllocationFlag::kNone));
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=1074&c=1
...
TF_BUILTIN(WasmStringEncodeWtf16Array, CodeStubAssembler) {
  ...
  if (block2.is_used()) {
    ...
    tmp118 = CodeStubAssembler(state_).SmiConstant(CastIfEnumClass<MessageTemplate>(MessageTemplate::kWasmTrapArrayOutOfBounds));
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=1382&c=1
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=1387&c=1
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=1404&c=1
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=1541&c=1
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=1544&c=1
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=1547&c=1
...
TF_BUILTIN(WasmLiftoffCastEqRefUnshared, CodeStubAssembler) {
  ...
  compiler::CodeAssemblerParameterizedLabel<BoolT, BoolT> block45(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<BoolT, BoolT> block44(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<BoolT> block40(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<BoolT, BoolT> block41(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<BoolT> block25(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block21(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block22(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    tmp5 = TORQUE_CAST(TNode<Object>{parameter0});
    tmp6 = WasmBuiltinsAssembler(state_).InSharedSpace(TNode<HeapObject>{tmp5});
    ca_.Branch(tmp6, &block23, std::vector<compiler::Node*>{}, &block24, std::vector<compiler::Node*>{});
  }
  ...
  if (block24.is_used()) {
    ca_.Bind(&block24);
    compiler::CodeAssemblerLabel label9(&ca_);
    tmp8 = Cast_WasmArray_0(state_, TNode<HeapObject>{tmp5}, &label9);
    ca_.Goto(&block29);
    if (label9.is_used()) {
      ca_.Bind(&label9);
      ca_.Goto(&block30);
  ...
  if (block26.is_used()) {
    ...
    tmp12 = CodeStubAssembler(state_).Word32BinaryNot(TNode<BoolT>{phi_bb26_6});
    ca_.Branch(tmp12, &block31, std::vector<compiler::Node*>{}, &block32, std::vector<compiler::Node*>{});
  }

  TNode<WasmStruct> tmp13;
  if (block31.is_used()) {
    ca_.Bind(&block31);
    compiler::CodeAssemblerLabel label14(&ca_);
    tmp13 = Cast_WasmStruct_0(state_, TNode<HeapObject>{tmp5}, &label14);
    ca_.Goto(&block37);
    if (label14.is_used()) {
      ca_.Bind(&label14);
      ca_.Goto(&block38);
  ...
  if (block34.is_used()) {
    ...
    tmp17 = CodeStubAssembler(state_).Word32BinaryNot(TNode<BoolT>{phi_bb34_7});
    ca_.Goto(&block33, tmp17);
  }
  ...
  if (block32.is_used()) {
    ca_.Bind(&block32);
    tmp18 = FromConstexpr_bool_constexpr_bool_0(state_, false);
    ca_.Goto(&block33, tmp18);
  }

  TNode<BoolT> phi_bb33_5;
  if (block33.is_used()) {
    ca_.Bind(&block33, &phi_bb33_5);
    ca_.Branch(phi_bb33_5, &block39, std::vector<compiler::Node*>{phi_bb33_5}, &block40, std::vector<compiler::Node*>{phi_bb33_5});
  }

  TNode<BoolT> phi_bb39_4;
  TNode<BoolT> tmp19;
  if (block39.is_used()) {
    ca_.Bind(&block39, &phi_bb39_4);
    tmp19 = CodeStubAssembler(state_).Word32BinaryNot(TNode<BoolT>{parameter1});
    ca_.Branch(tmp19, &block42, std::vector<compiler::Node*>{phi_bb39_4}, &block43, std::vector<compiler::Node*>{phi_bb39_4});
  }

  TNode<BoolT> phi_bb42_4;
  TNode<BoolT> tmp20;
  if (block42.is_used()) {
    ca_.Bind(&block42, &phi_bb42_4);
    tmp20 = FromConstexpr_bool_constexpr_bool_0(state_, true);
    ca_.Goto(&block44, phi_bb42_4, tmp20);
  }

  TNode<BoolT> phi_bb43_4;
  TNode<WasmNull> tmp21;
  if (block43.is_used()) {
    ca_.Bind(&block43, &phi_bb43_4);
    compiler::CodeAssemblerLabel label22(&ca_);
    tmp21 = Cast_WasmNull_0(state_, TNode<HeapObject>{tmp5}, &label22);
    ca_.Goto(&block48, phi_bb43_4);
    if (label22.is_used()) {
      ca_.Bind(&label22);
      ca_.Goto(&block49, phi_bb43_4);
    }
  }

  TNode<BoolT> phi_bb49_4;
  TNode<BoolT> tmp23;
  if (block49.is_used()) {
    ca_.Bind(&block49, &phi_bb49_4);
    tmp23 = FromConstexpr_bool_constexpr_bool_0(state_, false);
    ca_.Goto(&block45, phi_bb49_4, tmp23);
  }

  TNode<BoolT> phi_bb48_4;
  TNode<BoolT> tmp24;
  if (block48.is_used()) {
    ca_.Bind(&block48, &phi_bb48_4);
    tmp24 = FromConstexpr_bool_constexpr_bool_0(state_, true);
    ca_.Goto(&block45, phi_bb48_4, tmp24);
  }

  TNode<BoolT> phi_bb45_4;
  TNode<BoolT> phi_bb45_8;
  TNode<BoolT> tmp25;
  if (block45.is_used()) {
    ca_.Bind(&block45, &phi_bb45_4, &phi_bb45_8);
    tmp25 = CodeStubAssembler(state_).Word32BinaryNot(TNode<BoolT>{phi_bb45_8});
    ca_.Goto(&block44, phi_bb45_4, tmp25);
  }

  TNode<BoolT> phi_bb44_4;
  TNode<BoolT> phi_bb44_6;
  if (block44.is_used()) {
    ca_.Bind(&block44, &phi_bb44_4, &phi_bb44_6);
    ca_.Goto(&block41, phi_bb44_4, phi_bb44_6);
  }
  ...
  if (block40.is_used()) {
    ca_.Bind(&block40, &phi_bb40_4);
    tmp26 = FromConstexpr_bool_constexpr_bool_0(state_, false);
    ca_.Goto(&block41, phi_bb40_4, tmp26);
  }

  TNode<BoolT> phi_bb41_4;
  TNode<BoolT> phi_bb41_5;
  if (block41.is_used()) {
    ca_.Bind(&block41, &phi_bb41_4, &phi_bb41_5);
    ca_.Goto(&block25, phi_bb41_5);
  }

  TNode<BoolT> phi_bb25_4;
  if (block25.is_used()) {
    ca_.Bind(&block25, &phi_bb25_4);
    ca_.Branch(phi_bb25_4, &block21, std::vector<compiler::Node*>{}, &block22, std::vector<compiler::Node*>{});
  }
  ...
  if (block22.is_used()) {
    ca_.Bind(&block22);
    tmp27 = SmiConstant_0(state_, IntegerLiteral(false, 0x0ull));
    CodeStubAssembler(state_).Return(tmp27);
  }
}
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=389&c=12
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=389&c=38
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=389&c=61
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=421&c=10
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=421&c=36
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=600&c=7
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=688&c=20
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=1127&c=12
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=1131&c=10
TNode<SeqOneByteString> AllocateNonEmptySeqOneByteString_TwoByteToOneByteIterator_0(compiler::CodeAssemblerState* state_, TNode<Uint32T> p_length, TorqueStructTwoByteToOneByteIterator_0 p_content) {
  ...
  if (block0.is_used()) {
    ...
    tmp5 = AddIndexedFieldSizeToObjectSize_0(state_, TNode<IntPtrT>{tmp4}, TNode<IntPtrT>{tmp3}, CastIfEnumClass<int32_t>(kUInt8Size));
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=1290&c=26
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=1299&c=39
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=1512&c=14
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=1728&c=23
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=1750&c=10
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=1750&c=39
...
// https://crsrc.org/c/v8/src/builtins/wasm.tq?l=1019&c=10
