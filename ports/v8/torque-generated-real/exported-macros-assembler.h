...
class V8_EXPORT_PRIVATE TorqueGeneratedExportedMacrosAssembler {
 public:
  ...
  TorqueStructSlice_TrustedObject_OR_Smi_MutableReference_TrustedObject_OR_Smi_0 FieldSliceProtectedFixedArrayObjects(TNode<ProtectedFixedArray> p_o);
  // https://crsrc.org/c/v8/src/objects/fixed-array.tq?l=28&c=3
  ...
  TorqueStructSlice_TrustedObject_OR_Smi_MutableReference_TrustedObject_OR_Smi_0 FieldSliceProtectedWeakFixedArrayObjects(TNode<ProtectedWeakFixedArray> p_o);
  // https://crsrc.org/c/v8/src/objects/fixed-array.tq?l=59&c=3
  ...
  TorqueStructSlice_Name_OR_Smi_MutableReference_Name_OR_Smi_0 FieldSliceScopeInfoSavedClassVariableInfo(TNode<ScopeInfo> p_o);
  // https://crsrc.org/c/v8/src/objects/scope-info.tq?l=164&c=3
  ...
  TNode<Foreign> LoadJSTemporalDurationDuration(TNode<JSTemporalDuration> p_o);
  // https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=8&c=3
  void StoreJSTemporalDurationDuration(TNode<JSTemporalDuration> p_o, TNode<Foreign> p_v);
  // https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=12&c=3
  TNode<Foreign> LoadJSTemporalInstantInstant(TNode<JSTemporalInstant> p_o);
  // https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=12&c=3
  void StoreJSTemporalInstantInstant(TNode<JSTemporalInstant> p_o, TNode<Foreign> p_v);
  // https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=16&c=3
  TNode<Foreign> LoadJSTemporalPlainDateTimeDateTime(TNode<JSTemporalPlainDateTime> p_o);
  // https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=16&c=3
  void StoreJSTemporalPlainDateTimeDateTime(TNode<JSTemporalPlainDateTime> p_o, TNode<Foreign> p_v);
  // https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=20&c=3
  TNode<Foreign> LoadJSTemporalPlainDateDate(TNode<JSTemporalPlainDate> p_o);
  // https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=20&c=3
  void StoreJSTemporalPlainDateDate(TNode<JSTemporalPlainDate> p_o, TNode<Foreign> p_v);
  // https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=24&c=3
  TNode<Foreign> LoadJSTemporalPlainMonthDayMonthDay(TNode<JSTemporalPlainMonthDay> p_o);
  // https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=24&c=3
  void StoreJSTemporalPlainMonthDayMonthDay(TNode<JSTemporalPlainMonthDay> p_o, TNode<Foreign> p_v);
  // https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=28&c=3
  TNode<Foreign> LoadJSTemporalPlainTimeTime(TNode<JSTemporalPlainTime> p_o);
  // https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=28&c=3
  void StoreJSTemporalPlainTimeTime(TNode<JSTemporalPlainTime> p_o, TNode<Foreign> p_v);
  // https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=32&c=3
  TNode<Foreign> LoadJSTemporalPlainYearMonthYearMonth(TNode<JSTemporalPlainYearMonth> p_o);
  // https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=32&c=3
  void StoreJSTemporalPlainYearMonthYearMonth(TNode<JSTemporalPlainYearMonth> p_o, TNode<Foreign> p_v);
  // https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=36&c=3
  TNode<Foreign> LoadJSTemporalZonedDateTimeZonedDateTime(TNode<JSTemporalZonedDateTime> p_o);
  // https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=36&c=3
  void StoreJSTemporalZonedDateTimeZonedDateTime(TNode<JSTemporalZonedDateTime> p_o, TNode<Foreign> p_v);
