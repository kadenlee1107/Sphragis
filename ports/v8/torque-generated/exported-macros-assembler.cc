...
// https://crsrc.org/c/v8/src/objects/ordered-hash-table.tq?l=39&c=1
...
// https://crsrc.org/c/v8/src/objects/ordered-hash-table.tq?l=78&c=1
...
// https://crsrc.org/c/v8/src/objects/scope-info.tq?l=211&c=1
...
// https://crsrc.org/c/v8/src/objects/scope-info.tq?l=223&c=1
...
// https://crsrc.org/c/v8/src/objects/map.tq?l=105&c=1
...
// https://crsrc.org/c/v8/src/objects/map.tq?l=114&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=777&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=796&c=1
void TorqueGeneratedExportedMacrosAssembler::TestConstInStructs() {
return TestConstInStructs_0(state_);}

// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=807&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=823&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=843&c=1
void TorqueGeneratedExportedMacrosAssembler::TestReferences() {
return TestReferences_0(state_);}

// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=854&c=1
void TorqueGeneratedExportedMacrosAssembler::TestSlices() {
return TestSlices_0(state_);}

// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=882&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=911&c=1
void TorqueGeneratedExportedMacrosAssembler::TestStaticAssert() {
return TestStaticAssert_0(state_);}

// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=939&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=953&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=965&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=980&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=999&c=1
TNode<IntPtrT> TorqueGeneratedExportedMacrosAssembler::TestGenericStruct1() {
return TestGenericStruct1_0(state_);}

// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1020&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1042&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1062&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1109&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1150&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1210&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1223&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1257&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1264&c=1
void TorqueGeneratedExportedMacrosAssembler::TestWord8Phi() {
return TestWord8Phi_0(state_);}

// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1277&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1300&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1307&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1326&c=1
void TorqueGeneratedExportedMacrosAssembler::TestCreateLazyNodeFromTorque() {
return TestCreateLazyNodeFromTorque_0(state_);}

// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1350&c=1
...
// https://crsrc.org/c/v8/src/objects/js-generator.tq?l=7&c=3
...
// https://crsrc.org/c/v8/src/objects/js-generator.tq?l=8&c=3
...
// https://crsrc.org/c/v8/src/objects/js-generator.tq?l=17&c=3
...
// https://crsrc.org/c/v8/src/objects/js-generator.tq?l=22&c=3
...
// https://crsrc.org/c/v8/src/objects/js-generator.tq?l=25&c=3
...
// https://crsrc.org/c/v8/src/objects/js-generator.tq?l=33&c=3
...
// https://crsrc.org/c/v8/src/objects/js-generator.tq?l=39&c=3
...
// https://crsrc.org/c/v8/src/objects/js-regexp.tq?l=60&c=3
...
// https://crsrc.org/c/v8/src/objects/js-regexp.tq?l=102&c=3
...
// https://crsrc.org/c/v8/src/objects/js-regexp.tq?l=107&c=3
...
// https://crsrc.org/c/v8/src/objects/js-regexp.tq?l=112&c=3
...
// https://crsrc.org/c/v8/src/objects/js-regexp.tq?l=118&c=3
...
// https://crsrc.org/c/v8/src/objects/js-list-format.tq?l=15&c=3
...
// https://crsrc.org/c/v8/src/objects/js-segmenter.tq?l=14&c=3
...
// https://crsrc.org/c/v8/src/objects/map.tq?l=71&c=3
...
// https://crsrc.org/c/v8/src/objects/api-callbacks.tq?l=48&c=3
...
// https://crsrc.org/c/v8/src/objects/api-callbacks.tq?l=57&c=3
...
// https://crsrc.org/c/v8/src/objects/api-callbacks.tq?l=61&c=3
...
// https://crsrc.org/c/v8/src/objects/descriptor-array.tq?l=29&c=9
...
// https://crsrc.org/c/v8/src/objects/descriptor-array.tq?l=30&c=3
...
// https://crsrc.org/c/v8/src/objects/descriptor-array.tq?l=34&c=3
...
// https://crsrc.org/c/v8/src/objects/descriptor-array.tq?l=39&c=3
...
// https://crsrc.org/c/v8/src/objects/api-callbacks.tq?l=14&c=3
...
// https://crsrc.org/c/v8/src/objects/js-promise.tq?l=34&c=3
...
// https://crsrc.org/c/v8/src/objects/feedback-vector.tq?l=35&c=9
...
// https://crsrc.org/c/v8/src/objects/feedback-vector.tq?l=36&c=3
...
// https://crsrc.org/c/v8/src/objects/feedback-vector.tq?l=39&c=3
...
// https://crsrc.org/c/v8/src/objects/bytecode-array.tq?l=28&c=3
...
// https://crsrc.org/c/v8/src/objects/js-locale.tq?l=8&c=3
...
// https://crsrc.org/c/v8/src/objects/js-function.tq?l=11&c=3
...
// https://crsrc.org/c/v8/src/objects/js-function.tq?l=14&c=3
...
// https://crsrc.org/c/v8/src/objects/js-function.tq?l=17&c=3
...
// https://crsrc.org/c/v8/src/objects/js-function.tq?l=23&c=3
...
// https://crsrc.org/c/v8/src/objects/js-function.tq?l=25&c=3
...
TorqueStructSlice_TrustedObject_OR_Smi_MutableReference_TrustedObject_OR_Smi_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceProtectedFixedArrayObjects(TNode<ProtectedFixedArray> p_o) {
...
TorqueStructSlice_TrustedObject_OR_Smi_MutableReference_TrustedObject_OR_Smi_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceProtectedWeakFixedArrayObjects(TNode<ProtectedWeakFixedArray> p_o) {
...
// https://crsrc.org/c/v8/src/objects/js-number-format.tq?l=8&c=3
...
// https://crsrc.org/c/v8/src/objects/js-number-format.tq?l=11&c=3
...
// https://crsrc.org/c/v8/src/objects/js-plural-rules.tq?l=13&c=3
...
// https://crsrc.org/c/v8/src/objects/regexp-match-info.tq?l=15&c=3
...
// https://crsrc.org/c/v8/src/objects/regexp-match-info.tq?l=16&c=3
...
// https://crsrc.org/c/v8/src/objects/ordered-hash-table.tq?l=27&c=3
...
// https://crsrc.org/c/v8/src/objects/ordered-hash-table.tq?l=28&c=3
...
// https://crsrc.org/c/v8/src/objects/ordered-hash-table.tq?l=29&c=9
...
// https://crsrc.org/c/v8/src/objects/ordered-hash-table.tq?l=66&c=3
...
// https://crsrc.org/c/v8/src/objects/ordered-hash-table.tq?l=67&c=3
...
// https://crsrc.org/c/v8/src/objects/ordered-hash-table.tq?l=68&c=9
...
// https://crsrc.org/c/v8/src/objects/ordered-hash-table.tq?l=106&c=3
...
// https://crsrc.org/c/v8/src/objects/ordered-hash-table.tq?l=107&c=3
...
// https://crsrc.org/c/v8/src/objects/ordered-hash-table.tq?l=108&c=9
...
// https://crsrc.org/c/v8/src/objects/js-relative-time-format.tq?l=14&c=3
...
// https://crsrc.org/c/v8/src/objects/js-break-iterator.tq?l=8&c=3
...
// https://crsrc.org/c/v8/src/objects/js-display-names.tq?l=19&c=3
...
// https://crsrc.org/c/v8/src/objects/cpp-heap-external-object.tq?l=6&c=3
...
// https://crsrc.org/c/v8/src/objects/js-segments.tq?l=12&c=3
...
// https://crsrc.org/c/v8/src/objects/js-collection-iterator.tq?l=8&c=3
...
// https://crsrc.org/c/v8/src/objects/js-collection-iterator.tq?l=10&c=3
...
// https://crsrc.org/c/v8/src/objects/js-collator.tq?l=8&c=3
...
// https://crsrc.org/c/v8/src/objects/property-array.tq?l=6&c=3
...
// https://crsrc.org/c/v8/src/objects/js-disposable-stack.tq?l=30&c=3
...
// https://crsrc.org/c/v8/src/objects/js-weak-refs.tq?l=10&c=3
...
// https://crsrc.org/c/v8/src/objects/js-weak-refs.tq?l=17&c=3
...
// https://crsrc.org/c/v8/src/objects/js-weak-refs.tq?l=44&c=3
...
// https://crsrc.org/c/v8/src/objects/js-atomics-synchronization.tq?l=7&c=3
...
// https://crsrc.org/c/v8/src/objects/js-atomics-synchronization.tq?l=12&c=3
...
// https://crsrc.org/c/v8/src/objects/scope-info.tq?l=130&c=3
...
// https://crsrc.org/c/v8/src/objects/scope-info.tq?l=134&c=9
...
// https://crsrc.org/c/v8/src/objects/scope-info.tq?l=137&c=3
...
// https://crsrc.org/c/v8/src/objects/scope-info.tq?l=148&c=3
...
// https://crsrc.org/c/v8/src/objects/scope-info.tq?l=153&c=3
...
// https://crsrc.org/c/v8/src/objects/scope-info.tq?l=159&c=3
...
TorqueStructSlice_Name_OR_Smi_MutableReference_Name_OR_Smi_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceScopeInfoSavedClassVariableInfo(TNode<ScopeInfo> p_o) {
...
// https://crsrc.org/c/v8/src/objects/scope-info.tq?l=170&c=3
...
// https://crsrc.org/c/v8/src/objects/scope-info.tq?l=183&c=3
...
// https://crsrc.org/c/v8/src/objects/scope-info.tq?l=187&c=3
...
// https://crsrc.org/c/v8/src/objects/embedder-data-array.tq?l=7&c=3
...
TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSTemporalDurationDuration(TNode<JSTemporalDuration> p_o) {
return LoadJSTemporalDurationDuration_0(state_, p_o);}

// https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=8&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreJSTemporalDurationDuration(TNode<JSTemporalDuration> p_o, TNode<Foreign> p_v) {
return StoreJSTemporalDurationDuration_0(state_, p_o, p_v);}

// https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=12&c=3
TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSTemporalInstantInstant(TNode<JSTemporalInstant> p_o) {
return LoadJSTemporalInstantInstant_0(state_, p_o);}

// https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=12&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreJSTemporalInstantInstant(TNode<JSTemporalInstant> p_o, TNode<Foreign> p_v) {
return StoreJSTemporalInstantInstant_0(state_, p_o, p_v);}

// https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=16&c=3
TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSTemporalPlainDateTimeDateTime(TNode<JSTemporalPlainDateTime> p_o) {
return LoadJSTemporalPlainDateTimeDateTime_0(state_, p_o);}

// https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=16&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreJSTemporalPlainDateTimeDateTime(TNode<JSTemporalPlainDateTime> p_o, TNode<Foreign> p_v) {
return StoreJSTemporalPlainDateTimeDateTime_0(state_, p_o, p_v);}

// https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=20&c=3
TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSTemporalPlainDateDate(TNode<JSTemporalPlainDate> p_o) {
return LoadJSTemporalPlainDateDate_0(state_, p_o);}

// https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=20&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreJSTemporalPlainDateDate(TNode<JSTemporalPlainDate> p_o, TNode<Foreign> p_v) {
return StoreJSTemporalPlainDateDate_0(state_, p_o, p_v);}

// https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=24&c=3
TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSTemporalPlainMonthDayMonthDay(TNode<JSTemporalPlainMonthDay> p_o) {
return LoadJSTemporalPlainMonthDayMonthDay_0(state_, p_o);}

// https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=24&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreJSTemporalPlainMonthDayMonthDay(TNode<JSTemporalPlainMonthDay> p_o, TNode<Foreign> p_v) {
return StoreJSTemporalPlainMonthDayMonthDay_0(state_, p_o, p_v);}

// https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=28&c=3
TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSTemporalPlainTimeTime(TNode<JSTemporalPlainTime> p_o) {
return LoadJSTemporalPlainTimeTime_0(state_, p_o);}

// https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=28&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreJSTemporalPlainTimeTime(TNode<JSTemporalPlainTime> p_o, TNode<Foreign> p_v) {
return StoreJSTemporalPlainTimeTime_0(state_, p_o, p_v);}

// https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=32&c=3
TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSTemporalPlainYearMonthYearMonth(TNode<JSTemporalPlainYearMonth> p_o) {
return LoadJSTemporalPlainYearMonthYearMonth_0(state_, p_o);}

// https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=32&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreJSTemporalPlainYearMonthYearMonth(TNode<JSTemporalPlainYearMonth> p_o, TNode<Foreign> p_v) {
return StoreJSTemporalPlainYearMonthYearMonth_0(state_, p_o, p_v);}

// https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=36&c=3
TNode<Foreign> TorqueGeneratedExportedMacrosAssembler::LoadJSTemporalZonedDateTimeZonedDateTime(TNode<JSTemporalZonedDateTime> p_o) {
return LoadJSTemporalZonedDateTimeZonedDateTime_0(state_, p_o);}

// https://crsrc.org/c/v8/src/objects/js-temporal-objects.tq?l=36&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreJSTemporalZonedDateTimeZonedDateTime(TNode<JSTemporalZonedDateTime> p_o, TNode<Foreign> p_v) {
return StoreJSTemporalZonedDateTimeZonedDateTime_0(state_, p_o, p_v);}
...
// https://crsrc.org/c/v8/src/objects/js-regexp-string-iterator.tq?l=13&c=3
...
// https://crsrc.org/c/v8/src/objects/js-regexp-string-iterator.tq?l=15&c=3
...
// https://crsrc.org/c/v8/src/objects/js-shadow-realm.tq?l=6&c=3
...
// https://crsrc.org/c/v8/src/objects/js-date-time-format.tq?l=20&c=3
...
// https://crsrc.org/c/v8/src/objects/debug-objects.tq?l=66&c=9
...
// https://crsrc.org/c/v8/src/objects/debug-objects.tq?l=83&c=3
...
// https://crsrc.org/c/v8/src/objects/debug-objects.tq?l=91&c=3
...
// https://crsrc.org/c/v8/src/objects/debug-objects.tq?l=93&c=3
...
// https://crsrc.org/c/v8/src/objects/debug-objects.tq?l=114&c=3
...
// https://crsrc.org/c/v8/src/objects/debug-objects.tq?l=116&c=3
...
// https://crsrc.org/c/v8/src/objects/literal-objects.tq?l=8&c=3
...
// https://crsrc.org/c/v8/src/objects/literal-objects.tq?l=9&c=3
...
// https://crsrc.org/c/v8/src/objects/literal-objects.tq?l=15&c=3
...
// https://crsrc.org/c/v8/src/objects/literal-objects.tq?l=16&c=3
...
// https://crsrc.org/c/v8/src/objects/literal-objects.tq?l=21&c=3
...
// https://crsrc.org/c/v8/src/objects/literal-objects.tq?l=22&c=3
...
// https://crsrc.org/c/v8/src/objects/literal-objects.tq?l=27&c=3
...
// https://crsrc.org/c/v8/src/objects/literal-objects.tq?l=28&c=3
...
// https://crsrc.org/c/v8/src/objects/literal-objects.tq?l=38&c=3
...
// https://crsrc.org/c/v8/src/objects/literal-objects.tq?l=39&c=3
...
// https://crsrc.org/c/v8/src/objects/js-duration-format.tq?l=44&c=3
...
// https://crsrc.org/c/v8/src/objects/js-segment-iterator.tq?l=12&c=3
...
// https://crsrc.org/c/v8/src/objects/js-segment-iterator.tq?l=20&c=3
...
// https://crsrc.org/c/v8/src/objects/js-segment-iterator.tq?l=21&c=3
...
// https://crsrc.org/c/v8/src/objects/js-segment-iterator.tq?l=28&c=3
...
// https://crsrc.org/c/v8/src/objects/js-collection.tq?l=10&c=3
...
// https://crsrc.org/c/v8/src/objects/js-collection.tq?l=18&c=3
...
// https://crsrc.org/c/v8/src/objects/turboshaft-types.tq?l=29&c=3
...
// https://crsrc.org/c/v8/src/objects/turboshaft-types.tq?l=30&c=3
...
// https://crsrc.org/c/v8/src/objects/turboshaft-types.tq?l=37&c=9
...
// https://crsrc.org/c/v8/src/objects/turboshaft-types.tq?l=50&c=3
...
// https://crsrc.org/c/v8/src/objects/turboshaft-types.tq?l=51&c=3
...
// https://crsrc.org/c/v8/src/objects/turboshaft-types.tq?l=60&c=9
...
// https://crsrc.org/c/v8/src/objects/turboshaft-types.tq?l=61&c=3
...
// https://crsrc.org/c/v8/src/objects/turboshaft-types.tq?l=62&c=3
...
// https://crsrc.org/c/v8/src/objects/turboshaft-types.tq?l=69&c=3
...
// https://crsrc.org/c/v8/src/objects/turboshaft-types.tq?l=76&c=3
...
// https://crsrc.org/c/v8/src/objects/turboshaft-types.tq?l=77&c=3
...
// https://crsrc.org/c/v8/src/objects/turboshaft-types.tq?l=78&c=3
...
// https://crsrc.org/c/v8/src/objects/turboshaft-types.tq?l=85&c=9
...
// https://crsrc.org/c/v8/third_party/v8/builtins/array-sort.tq?l=59&c=3
...
// https://crsrc.org/c/v8/third_party/v8/builtins/array-sort.tq?l=64&c=3
...
// https://crsrc.org/c/v8/third_party/v8/builtins/array-sort.tq?l=70&c=3
...
// https://crsrc.org/c/v8/third_party/v8/builtins/array-sort.tq?l=75&c=3
...
// https://crsrc.org/c/v8/third_party/v8/builtins/array-sort.tq?l=87&c=3
...
// https://crsrc.org/c/v8/third_party/v8/builtins/array-sort.tq?l=88&c=3
...
// https://crsrc.org/c/v8/third_party/v8/builtins/array-sort.tq?l=93&c=3
...
// https://crsrc.org/c/v8/third_party/v8/builtins/array-sort.tq?l=96&c=3
...
// https://crsrc.org/c/v8/third_party/v8/builtins/array-sort.tq?l=99&c=3
...
// https://crsrc.org/c/v8/third_party/v8/builtins/array-sort.tq?l=103&c=3
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=769&c=3
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=770&c=3
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=833&c=3
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=834&c=3
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=931&c=3
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=932&c=3
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1183&c=3
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1184&c=3
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1176&c=3
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1177&c=3
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1178&c=3
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1200&c=3
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1201&c=3
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1202&c=9
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1203&c=3
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1204&c=3
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1206&c=3
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1218&c=3
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1219&c=3
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1220&c=3
