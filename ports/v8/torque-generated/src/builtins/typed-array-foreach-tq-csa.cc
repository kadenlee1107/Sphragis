...
tmp9 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallInterfaceDescriptorFor(ExampleBuiltinForTorqueFunctionPointerType(0)), tmp2, TNode<Object>(), tmp8, phi_bb14_8));
...
// https://crsrc.org/c/v8/src/builtins/typed-array-foreach.tq?l=58&c=33
