...
TF_BUILTIN(CreateHTML, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp4 = CodeStubAssembler(state_).TaggedNotEqual(TNode<Object>{parameter4}, TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WeakCell>>{tmp3});
