...
TNode<BoolT> InSameNativeContext_0(compiler::CodeAssemblerState* state_, TNode<Context> p_lhs, TNode<Context> p_rhs) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = CodeStubAssembler(state_).TaggedEqual(TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WeakCell>>{tmp0}, TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WeakCell>>{tmp1});
    ca_.Goto(&block2);
  }
...
TNode<BoolT> TaggedEqualPrototypeApplyFunction_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_target) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{p_target}, TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WeakCell>>{tmp0});
    ca_.Goto(&block2);
  }
...
void CollectCallFeedback_0(compiler::CodeAssemblerState* state_, TNode<JSAny> p_maybeTarget, std::function<TNode<JSAny>()> p_maybeReceiver, TNode<Context> p_context, TNode<Union<FeedbackVector, Undefined>> p_maybeFeedbackVector, TNode<UintPtrT> p_slotId) {
  ...
  TNode<Union<HeapObject, Smi, Weak<HeapObject>>> tmp2;
  TNode<BoolT> tmp3;
  if (block11.is_used()) {
    ca_.Bind(&block11);
    ...
    tmp3 = IsMonomorphic_0(state_, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp2}, TNode<JSAny>{p_maybeTarget});
  ...
  if (block20.is_used()) {
    ca_.Bind(&block20);
    tmp4 = IsMegamorphic_0(state_, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp2});
  ...
  if (block22.is_used()) {
    ca_.Bind(&block22);
    tmp5 = IsUninitialized_0(state_, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp2});
  ...
  if (block24.is_used()) {
    ca_.Bind(&block24);
    compiler::CodeAssemblerLabel label7(&ca_);
    tmp6 = MaybeObjectToStrong_0(state_, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp2}, &label7);
    ca_.Goto(&block25);
    if (label7.is_used()) {
      ca_.Bind(&label7);
      ca_.Goto(&block26);
  ...
  if (block26.is_used()) {
    ca_.Bind(&block26);
    SetCallFeedbackContent_0(state_, TNode<Context>{p_context}, TNode<FeedbackVector>{tmp0}, TNode<UintPtrT>{p_slotId}, CastIfEnumClass<CallFeedbackContent>(CallFeedbackContent::kTarget));
    ca_.Goto(&block16);
  }
  ...
  if (block27.is_used()) {
    ...
    tmp12 = IsMonomorphic_0(state_, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp2}, TNode<JSAny>{tmp11});
  ...
  if (block37.is_used()) {
    ...
    tmp18 = CodeStubAssembler(state_).TaggedEqual(TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp6}, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp17});
  ...
  if (block41.is_used()) {
    ...
    tmp23 = CodeStubAssembler(state_).TaggedEqual(TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp22}, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp17});
  ...
  TNode<Union<HeapObject, Smi, Weak<HeapObject>>> tmp25;
  if (block44.is_used()) {
    ca_.Bind(&block44);
  ...
  if (block45.is_used()) {
    ...
    SetCallFeedbackContent_0(state_, TNode<Context>{p_context}, TNode<FeedbackVector>{tmp0}, TNode<UintPtrT>{p_slotId}, CastIfEnumClass<CallFeedbackContent>(CallFeedbackContent::kReceiver));
...
TNode<BoolT> BothTaggedEqualArrayFunction_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_first, TNode<JSAny> p_second) {
  ...
  if (block2.is_used()) {
    ...
    tmp2 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{p_second}, TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WeakCell>>{tmp1});
...
void CollectConstructFeedback_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_target, TNode<JSAny> p_newTarget, TNode<Union<FeedbackVector, Undefined>> p_maybeFeedbackVector, TNode<TaggedIndex> p_slotId, UpdateFeedbackMode p_updateFeedbackMode, compiler::CodeAssemblerLabel* label_ConstructGeneric, compiler::CodeAssemblerLabel* label_ConstructArray, compiler::TypedCodeAssemblerVariable<AllocationSite>* label_ConstructArray_parameter_0) {
  ...
  TNode<IntPtrT> tmp2;
  TNode<UintPtrT> tmp3;
  TNode<Union<HeapObject, Smi, Weak<HeapObject>>> tmp4;
  TNode<BoolT> tmp5;
  if (block12.is_used()) {
    ca_.Bind(&block12);
    ...
    tmp5 = IsMonomorphic_0(state_, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp4}, TNode<JSAny>{p_newTarget});
  ...
  if (block19.is_used()) {
    ca_.Bind(&block19);
    tmp6 = IsMegamorphic_0(state_, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp4});
  ...
  if (block21.is_used()) {
    ca_.Bind(&block21);
    tmp7 = IsUninitialized_0(state_, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp4});
  ...
  if (block23.is_used()) {
    ca_.Bind(&block23);
    tmp8 = CodeStubAssembler(state_).IsWeakOrCleared(TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp4});
  ...
  if (block24.is_used()) {
    ca_.Bind(&block24);
    tmp10 = TORQUE_CAST(TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp4});
  ...
  if (block25.is_used()) {
    ca_.Bind(&block25);
    compiler::CodeAssemblerLabel label15(&ca_);
    tmp14 = MaybeObjectToStrong_0(state_, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp4}, &label15);
    ca_.Goto(&block30);
    if (label15.is_used()) {
      ca_.Bind(&label15);
      ca_.Goto(&block31);
...
// https://crsrc.org/c/v8/src/builtins/ic-callable.tq?l=27&c=7
...
// https://crsrc.org/c/v8/src/builtins/ic-callable.tq?l=135&c=9
