...
TNode<JSAny> ConvertToAndFromWasm_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Uint32T> p_wasmType, TNode<JSAny> p_value) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_uint32_constexpr_uint32_0(state_, wasm::kWasmI32.raw_bit_field());
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    tmp6 = FromConstexpr_uint32_constexpr_uint32_0(state_, wasm::kWasmI64.raw_bit_field());
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    tmp16 = FromConstexpr_uint32_constexpr_uint32_0(state_, wasm::kWasmF32.raw_bit_field());
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    tmp20 = FromConstexpr_uint32_constexpr_uint32_0(state_, wasm::kWasmF64.raw_bit_field());
  ...
  if (block26.is_used()) {
    ca_.Bind(&block26);
    tmp26 = FromConstexpr_uint32_constexpr_uint32_0(state_, wasm::ValueType::kRefKindBits);
    tmp27 = CodeStubAssembler(state_).Word32And(TNode<Uint32T>{p_wasmType}, TNode<Uint32T>{tmp26});
    tmp28 = FromConstexpr_uint32_constexpr_uint32_0(state_, wasm::ValueType::kRefKindShift);
    tmp29 = CodeStubAssembler(state_).Word32Shr(TNode<Uint32T>{tmp27}, TNode<Uint32T>{tmp28});
    tmp30 = FromConstexpr_uint32_constexpr_uint32_0(state_, CastIfEnumClass<uint32_t>(wasm::RefTypeKind::kFunction));
...
TF_BUILTIN(JSToJSWrapper, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    std::tie(tmp27, tmp28) = NewOffHeapReference_RawPtr_uint32_0(state_, TNode<RawPtrT>{tmp26}).Flatten();
    ...
    std::tie(tmp31, tmp32, tmp33) = NewOffHeapConstSlice_uint32_0(state_, TNode<RawPtrT>{tmp29}, TNode<IntPtrT>{tmp30}).Flatten();
    ...
    std::tie(tmp35, tmp36, tmp37) = Subslice_uint32_0(state_, TorqueStructSlice_uint32_ConstReference_uint32_0{TNode<Union<HeapObject, TaggedIndex>>{tmp31}, TNode<IntPtrT>{tmp32}, TNode<IntPtrT>{tmp33}, TorqueStructUnsafe_0{}}, TNode<IntPtrT>{tmp34}, TNode<IntPtrT>{tmp13}, &label38).Flatten();
    ca_.Goto(&block3);
    if (label38.is_used()) {
      ca_.Bind(&label38);
      ca_.Goto(&block4);
  ...
  if (block3.is_used()) {
    ...
    std::tie(tmp39, tmp40, tmp41) = Subslice_uint32_0(state_, TorqueStructSlice_uint32_ConstReference_uint32_0{TNode<Union<HeapObject, TaggedIndex>>{tmp31}, TNode<IntPtrT>{tmp32}, TNode<IntPtrT>{tmp33}, TorqueStructUnsafe_0{}}, TNode<IntPtrT>{tmp13}, TNode<IntPtrT>{tmp21}, &label42).Flatten();
    ca_.Goto(&block7);
    if (label42.is_used()) {
      ca_.Bind(&label42);
      ca_.Goto(&block8);
  ...
  if (block17.is_used()) {
    ...
    tmp63 = TimesSizeOf_uint32_0(state_, TNode<IntPtrT>{phi_bb17_25});
    tmp64 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp40}, TNode<IntPtrT>{tmp63});
    std::tie(tmp65, tmp66) = NewReference_uint32_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp39}, TNode<IntPtrT>{tmp64}).Flatten();
  ...
  if (block37.is_used()) {
    ...
    tmp94 = TimesSizeOf_uint32_0(state_, TNode<IntPtrT>{tmp93});
    tmp95 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp36}, TNode<IntPtrT>{tmp94});
    std::tie(tmp96, tmp97) = NewReference_uint32_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp35}, TNode<IntPtrT>{tmp95}).Flatten();
  ...
  if (block49.is_used()) {
    ...
    tmp121 = TimesSizeOf_uint32_0(state_, TNode<IntPtrT>{phi_bb49_30});
    tmp122 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp36}, TNode<IntPtrT>{tmp121});
    std::tie(tmp123, tmp124) = NewReference_uint32_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp35}, TNode<IntPtrT>{tmp122}).Flatten();
