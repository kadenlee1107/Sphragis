...
TF_BUILTIN(IteratorFrom, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    tmp8 = True_0(state_);
    tmp9 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{tmp7}, TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WeakCell>>{tmp8});
