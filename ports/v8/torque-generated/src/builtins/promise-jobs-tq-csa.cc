...
TF_BUILTIN(PromiseResolveThenableJob, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp7 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{parameter3}, TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WeakCell>>{tmp4});
