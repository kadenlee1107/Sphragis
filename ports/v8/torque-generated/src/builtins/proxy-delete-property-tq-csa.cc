...
TF_BUILTIN(ProxyDeleteProperty, CodeStubAssembler) {
  ...
  if (block32.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{parameter0}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kProxyTrapReturnedFalsishFor), TNode<Object>{tmp15}, TNode<Object>{parameter2});
  }
...
// https://crsrc.org/c/v8/src/builtins/proxy-delete-property.tq?l=31&c=20
