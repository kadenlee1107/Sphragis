...
TF_BUILTIN(PromiseConstructor, CodeStubAssembler) {
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    tmp10 = CodeStubAssembler(state_).TaggedEqual(TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WeakCell>>{tmp7}, TNode<Object>{parameter2});
...
// https://crsrc.org/c/v8/src/builtins/promise-constructor.tq?l=49&c=23
...
// https://crsrc.org/c/v8/src/builtins/promise-constructor.tq?l=62&c=14
...
// https://crsrc.org/c/v8/src/builtins/promise-constructor.tq?l=78&c=6
