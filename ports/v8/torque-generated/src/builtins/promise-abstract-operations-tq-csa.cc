...
void MorphAndEnqueuePromiseReaction_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<PromiseReaction> p_promiseReaction, TNode<JSAny> p_argument, PromiseReaction::Type p_reactionType) {
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    tmp21 = FromConstexpr_bool_constexpr_bool_0(state_, (CodeStubAssembler(state_).ConstexprInt31Equal(CastIfEnumClass<int31_t>(p_reactionType), CastIfEnumClass<int31_t>(PromiseReaction::kReject))));
    CodeStubAssembler(state_).StaticAssert(TNode<BoolT>{tmp21}, "static_assert(reactionType == kPromiseReactionReject) at https://crsrc.org/c/v8/src/builtins/promise-abstract-operations.tq?l=136&c=5");
    tmp22 = FromConstexpr_intptr_constexpr_int31_0(state_, 0);
    std::tie(tmp23, tmp24) = UnsafeConstCast_Map_0(state_, TorqueStructReference_Map_0{TNode<Union<HeapObject, TaggedIndex>>{p_promiseReaction}, TNode<IntPtrT>{tmp22}, TorqueStructUnsafe_0{}}).Flatten();
    ...
    CodeStubAssembler(state_).StoreReference<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction, Undefined>>(CodeStubAssembler::Reference{tmp26, tmp29}, phi_bb4_3);
    tmp30 = ca_.CallBuiltin<Undefined>(Builtin::kEnqueueMicrotask, tmp9, tmp26);
    tmp31 = FromConstexpr_bool_constexpr_bool_0(state_, (CodeStubAssembler(state_).ConstexprInt31Equal(ObjectTraits<PromiseReaction>::kPromiseOrCapabilityOffset, ObjectTraits<PromiseReactionJobTask>::kPromiseOrCapabilityOffset)));
...
TF_BUILTIN(FulfillPromise, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = UnsafeCast_PromiseReaction_OR_Zero_0(state_, TNode<Context>{parameter0}, TNode<Object>{tmp1});
...
TF_BUILTIN(RejectPromise, CodeStubAssembler) {
  ...
  if (block2.is_used()) {
    ...
    tmp8 = UnsafeCast_PromiseReaction_OR_Zero_0(state_, TNode<Context>{parameter0}, TNode<Object>{tmp7});
...
TNode<PromiseCapability> InnerNewPromiseCapability_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<HeapObject> p_constructor, TNode<Boolean> p_debugEvent) {
  ...
  if (block0.is_used()) {
    ...
    tmp5 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{p_constructor}, TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WeakCell>>{tmp4});
...
void PerformPromiseThenImpl_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSPromise> p_promise, TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction, Undefined>> p_onFulfilled, TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction, Undefined>> p_onRejected, TNode<Union<JSPromise, PromiseCapability, Undefined>> p_resultPromiseOrCapability) {
  ...
  if (block2.is_used()) {
    ...
    tmp5 = UnsafeCast_PromiseReaction_OR_Zero_0(state_, TNode<Context>{p_context}, TNode<Object>{tmp4});
...
TF_BUILTIN(PerformPromiseThenFunction, CodeStubAssembler) {
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    compiler::CodeAssemblerLabel label3(&ca_);
    tmp2 = Cast_JSFunction_OR_Undefined_OR_JSBoundFunction_OR_JSWrappedFunction_OR_CallableJSProxy_OR_CallableApiObject_1(state_, TNode<Context>{parameter0}, TNode<Object>{parameter2}, &label3);
    ca_.Goto(&block7);
    if (label3.is_used()) {
      ca_.Bind(&label3);
      ca_.Goto(&block8);
  ...
  if (block7.is_used()) {
    ...
    tmp4 = Cast_JSFunction_OR_Undefined_OR_JSBoundFunction_OR_JSWrappedFunction_OR_CallableJSProxy_OR_CallableApiObject_1(state_, TNode<Context>{parameter0}, TNode<Object>{parameter3}, &label5);
    ca_.Goto(&block11);
    if (label5.is_used()) {
      ca_.Bind(&label5);
      ca_.Goto(&block12);
...
TF_BUILTIN(PromiseReject, CodeStubAssembler) {
  ...
  if (block3.is_used()) {
    ...
    tmp6 = CodeStubAssembler(state_).TaggedEqual(TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WeakCell>>{tmp5}, TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WeakCell>>{tmp0});
...
TNode<BoolT> IsPromiseResolveLookupChainIntact_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TNode<JSReceiver> p_constructor) {
  ...
  if (block3.is_used()) {
    ...
    tmp5 = CodeStubAssembler(state_).LoadReference<JSFunction>(CodeStubAssembler::Reference{tmp3, tmp4});
    tmp6 = CodeStubAssembler(state_).TaggedEqual(TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WeakCell>>{tmp5}, TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WeakCell>>{p_constructor});
...
TNode<JSAny> CallResolve_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_constructor, TNode<JSAny> p_resolve, TNode<JSAny> p_value) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = Undefined_0(state_);
    tmp1 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{p_resolve}, TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WeakCell>>{tmp0});
...
TNode<Union<PromiseReaction, Smi>> UnsafeCast_PromiseReaction_OR_Zero_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
