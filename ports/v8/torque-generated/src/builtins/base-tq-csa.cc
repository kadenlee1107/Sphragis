...
TNode<HeapObject> MaybeObjectToStrong_0(compiler::CodeAssemblerState* state_, TNode<Union<HeapObject, Smi, Weak<HeapObject>>> p_maybeObject, compiler::CodeAssemblerLabel* label_IfCleared) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = TORQUE_CAST(TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{p_maybeObject});
    compiler::CodeAssemblerLabel label2(&ca_);
    tmp1 = WeakToStrong_HeapObject_0(state_, TNode<Weak<HeapObject>>{tmp0}, &label2);
    ca_.Goto(&block7);
    if (label2.is_used()) {
      ca_.Bind(&label2);
      ca_.Goto(&block8);
...
TNode<Int32T> FastHoleyElementsKind_0(compiler::CodeAssemblerState* state_, TNode<Int32T> p_kind) {
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    tmp12 = FromConstexpr_ElementsKind_constexpr_HOLEY_ELEMENTS_0(state_, ElementsKind::HOLEY_ELEMENTS);
    ca_.Goto(&block1, tmp12);
  }
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1, &phi_bb1_1);
    ca_.Goto(&block20, phi_bb1_1);
  }

  TNode<Int32T> phi_bb20_1;
    ca_.Bind(&block20, &phi_bb20_1);
  return TNode<Int32T>{phi_bb20_1};
}
...
TNode<UintPtrT> ToUintPtr_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_value, compiler::CodeAssemblerLabel* label_IfLessThanZero, compiler::CodeAssemblerLabel* label_IfUIntPtrOverflow, compiler::CodeAssemblerLabel* label_IfSafeIntegerOverflow) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{p_value}, TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WeakCell>>{tmp0});
...
TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction>> GetMethod_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_o, TNode<Union<String, Symbol>> p_name, compiler::CodeAssemblerLabel* label_IfNullOrUndefined, compiler::CodeAssemblerLabel* label_IfMethodNotCallable, compiler::TypedCodeAssemblerVariable<JSAny>* label_IfMethodNotCallable_parameter_0) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{tmp0}, TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WeakCell>>{tmp1});
  ...
  if (block11.is_used()) {
    ca_.Bind(&block11);
    tmp4 = Null_0(state_);
    tmp5 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{tmp0}, TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WeakCell>>{tmp4});
...
TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction>> GetMethod_1(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_o, TNode<String> p_name, compiler::CodeAssemblerLabel* label_IfNullOrUndefined) {
  ...
  if (block11.is_used()) {
    ca_.Bind(&block11);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{p_context}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kPropertyNotFunction), TNode<Object>{tmp3.value()}, TNode<Object>{p_name}, TNode<Object>{p_o});
  }
...
TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction>> GetMethod_3(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_o, TNode<Symbol> p_symbol, compiler::CodeAssemblerLabel* label_IfNullOrUndefined) {
  ...
  if (block15.is_used()) {
    ca_.Bind(&block15);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{p_context}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kPropertyNotFunction), TNode<Object>{tmp0}, TNode<Object>{p_symbol}, TNode<Object>{p_o});
  }
...
TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction>> GetInterestingMethod_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<String> p_name, compiler::CodeAssemblerLabel* label_IfNullOrUndefined) {
  ...
  if (block11.is_used()) {
    ...
    tmp3 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{tmp0}, TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WeakCell>>{tmp2});
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    tmp5 = Null_0(state_);
    tmp6 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{tmp0}, TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WeakCell>>{tmp5});
  ...
  if (block21.is_used()) {
    ca_.Bind(&block21);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{p_context}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kPropertyNotFunction), TNode<Object>{tmp0}, TNode<Object>{p_name}, TNode<Object>{p_o});
  }
...
TF_BUILTIN(FastCreateDataProperty, CodeStubAssembler) {
  ...
  if (block30.is_used()) {
    ...
    CodeStubAssembler(state_).BuildAppendJSArray(CastIfEnumClass<ElementsKind>(ElementsKind::HOLEY_ELEMENTS), TNode<JSArray>{tmp0}, TNode<JSAny>{parameter3}, &label23);
    ca_.Goto(&block38);
    if (label23.is_used()) {
      ca_.Bind(&label23);
      ca_.Goto(&block39);
  ...
  if (block15.is_used()) {
    ...
    tmp25 = CodeStubAssembler(state_).LoadReference<Map>(CodeStubAssembler::Reference{tmp0, tmp24});
    tmp26 = CodeStubAssembler(state_).LoadMapElementsKind(TNode<Map>{tmp25});
    EnsureWriteableFastElements_0(state_, TNode<Context>{parameter0}, TNode<JSArray>{tmp0});
    tmp27 = CodeStubAssembler(state_).IsFastSmiElementsKind(TNode<Int32T>{tmp26});
    ca_.Branch(tmp27, &block40, std::vector<compiler::Node*>{}, &block41, std::vector<compiler::Node*>{});
  }
  ...
  if (block40.is_used()) {
    ...
    tmp28 = Cast_Smi_0(state_, TNode<Object>{parameter3}, &label29);
    ca_.Goto(&block43);
    if (label29.is_used()) {
      ca_.Bind(&label29);
      ca_.Goto(&block44);
  ...
  if (block43.is_used()) {
    ...
    tmp31 = CodeStubAssembler(state_).LoadReference<FixedArrayBase>(CodeStubAssembler::Reference{tmp0, tmp30});
    compiler::CodeAssemblerLabel label33(&ca_);
    tmp32 = Cast_FixedArray_0(state_, TNode<HeapObject>{tmp31}, &label33);
    ca_.Goto(&block47);
    if (label33.is_used()) {
      ca_.Bind(&label33);
      ca_.Goto(&block48);
  ...
  if (block47.is_used()) {
    ca_.Bind(&block47);
    StoreFixedArrayDirect_0(state_, TNode<FixedArray>{tmp32}, TNode<Smi>{tmp2}, TNode<Object>{tmp28});
    ca_.Goto(&block42);
  }
  ...
  if (block41.is_used()) {
    ca_.Bind(&block41);
    tmp34 = CodeStubAssembler(state_).IsDoubleElementsKind(TNode<Int32T>{tmp26});
    ca_.Branch(tmp34, &block49, std::vector<compiler::Node*>{}, &block50, std::vector<compiler::Node*>{});
  }
  ...
  if (block49.is_used()) {
    ...
    tmp35 = Cast_Number_0(state_, TNode<Object>{parameter3}, &label36);
    ca_.Goto(&block52);
    if (label36.is_used()) {
      ca_.Bind(&label36);
      ca_.Goto(&block53);
  ...
  if (block56.is_used()) {
    ca_.Bind(&block56);
    StoreFixedDoubleArrayDirect_0(state_, TNode<FixedDoubleArray>{tmp39}, TNode<Smi>{tmp2}, TNode<Number>{tmp35});
    ca_.Goto(&block51);
  }
  ...
  if (block64.is_used()) {
    ca_.Bind(&block64);
    StoreFixedArrayDirect_0(state_, TNode<FixedArray>{tmp43}, TNode<Smi>{tmp2}, TNode<Object>{parameter3});
    ca_.Goto(&block51);
  }
...
void VerifiedUnreachable_0(compiler::CodeAssemblerState* state_) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_bool_constexpr_bool_0(state_, false);
    CodeStubAssembler(state_).StaticAssert(TNode<BoolT>{tmp0}, "static_assert(false) at https://crsrc.org/c/v8/src/builtins/base.tq?l=2159&c=3");
    CodeStubAssembler(state_).Unreachable();
  }
}
...
TNode<JSReceiver> GetOptionsObject_0(compiler::CodeAssemblerState* state_, TNode<NativeContext> p_context, TNode<JSAny> p_options) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = Undefined_0(state_);
    tmp1 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{p_options}, TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WeakCell>>{tmp0});
    ca_.Branch(tmp1, &block2, std::vector<compiler::Node*>{}, &block3, std::vector<compiler::Node*>{});
  }
