...
TNode<Context> CreateArrayFromAsyncIterableResolveContext_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArrayFromAsyncIterableResumeState_0 p_resumeState, TNode<JSPromise> p_promise, TNode<JSReceiver> p_promiseFun, TNode<JSReceiver> p_iterator, TNode<JSAny> p_next, TNode<JSReceiver> p_arr, TNode<JSAny> p_error, TNode<JSAny> p_mapfn, TNode<JSAny> p_thisArg, TNode<NativeContext> p_nativeContext) {
  ...
  if (block0.is_used()) {
    ...
    InitContextSlot_ArrayFromAsyncIterableResolveContext_ArrayFromAsyncIterableResolveContext_JSFunction_OR_Undefined_JSFunction_0(state_, TNode<Context>{tmp2}, TNode<IntPtrT>{tmp9}, TNode<JSFunction>{tmp10});
    ...
    InitContextSlot_ArrayFromAsyncIterableResolveContext_ArrayFromAsyncIterableResolveContext_JSFunction_OR_Undefined_JSFunction_0(state_, TNode<Context>{tmp2}, TNode<IntPtrT>{tmp11}, TNode<JSFunction>{tmp12});
...
TNode<Context> CreateArrayFromAsyncArrayLikeResolveContext_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArrayFromAsyncArrayLikeResumeState_0 p_resumeState, TNode<JSPromise> p_promise, TNode<JSReceiver> p_promiseFun, TNode<JSReceiver> p_arrayLike, TNode<JSReceiver> p_arr, TNode<JSAny> p_error, TNode<JSAny> p_mapfn, TNode<JSAny> p_thisArg, TNode<NativeContext> p_nativeContext) {
  ...
  if (block0.is_used()) {
    ...
    InitContextSlot_ArrayFromAsyncArrayLikeResolveContext_ArrayFromAsyncArrayLikeResolveContext_JSFunction_OR_Undefined_JSFunction_0(state_, TNode<Context>{tmp2}, TNode<IntPtrT>{tmp10}, TNode<JSFunction>{tmp11});
    ...
    InitContextSlot_ArrayFromAsyncArrayLikeResolveContext_ArrayFromAsyncArrayLikeResolveContext_JSFunction_OR_Undefined_JSFunction_0(state_, TNode<Context>{tmp2}, TNode<IntPtrT>{tmp12}, TNode<JSFunction>{tmp13});
...
void InitContextSlot_ArrayFromAsyncIterableResolveContext_ArrayFromAsyncIterableResolveContext_JSFunction_OR_Undefined_JSFunction_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_index, TNode<JSFunction> p_value) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block18(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TNode<JSAny> ArrayFromAsyncAwaitPoint_ArrayFromAsyncIterableResolveContext_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Context> p_resolveContext, TNode<IntPtrT> p_stepSlot, TNode<IntPtrT> p_promiseFunSlot, TNode<IntPtrT> p_resolveSlot, TNode<IntPtrT> p_rejectSlot, TNode<Uint32T> p_step, TNode<JSAny> p_value) {
  ...
  if (block0.is_used()) {
    ...
    std::tie(tmp6, tmp7) = ContextSlot_ArrayFromAsyncIterableResolveContext_ArrayFromAsyncIterableResolveContext_JSFunction_OR_Undefined_0(state_, TNode<Context>{p_resolveContext}, TNode<IntPtrT>{p_resolveSlot}).Flatten();
    tmp8 = CodeStubAssembler(state_).LoadReference<Union<JSFunction, Undefined>>(CodeStubAssembler::Reference{tmp6, tmp7});
    std::tie(tmp9, tmp10) = ContextSlot_ArrayFromAsyncIterableResolveContext_ArrayFromAsyncIterableResolveContext_JSFunction_OR_Undefined_0(state_, TNode<Context>{p_resolveContext}, TNode<IntPtrT>{p_rejectSlot}).Flatten();
...
void InitContextSlot_ArrayFromAsyncArrayLikeResolveContext_ArrayFromAsyncArrayLikeResolveContext_JSFunction_OR_Undefined_JSFunction_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_index, TNode<JSFunction> p_value) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block18(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TNode<JSAny> ArrayFromAsyncAwaitPoint_ArrayFromAsyncArrayLikeResolveContext_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Context> p_resolveContext, TNode<IntPtrT> p_stepSlot, TNode<IntPtrT> p_promiseFunSlot, TNode<IntPtrT> p_resolveSlot, TNode<IntPtrT> p_rejectSlot, TNode<Uint32T> p_step, TNode<JSAny> p_value) {
  ...
  if (block0.is_used()) {
    ...
    tmp5 = CodeStubAssembler(state_).LoadReference<JSReceiver>(CodeStubAssembler::Reference{tmp3, tmp4});
    std::tie(tmp6, tmp7) = ContextSlot_ArrayFromAsyncArrayLikeResolveContext_ArrayFromAsyncArrayLikeResolveContext_JSFunction_OR_Undefined_0(state_, TNode<Context>{p_resolveContext}, TNode<IntPtrT>{p_resolveSlot}).Flatten();
    tmp8 = CodeStubAssembler(state_).LoadReference<Union<JSFunction, Undefined>>(CodeStubAssembler::Reference{tmp6, tmp7});
    std::tie(tmp9, tmp10) = ContextSlot_ArrayFromAsyncArrayLikeResolveContext_ArrayFromAsyncArrayLikeResolveContext_JSFunction_OR_Undefined_0(state_, TNode<Context>{p_resolveContext}, TNode<IntPtrT>{p_rejectSlot}).Flatten();
    tmp11 = CodeStubAssembler(state_).LoadReference<Union<JSFunction, Undefined>>(CodeStubAssembler::Reference{tmp9, tmp10});
    tmp12 = ca_.CallBuiltin<JSAny>(Builtin::kPromiseResolve, p_context, tmp5, p_value);
    tmp13 = UnsafeCast_JSPromise_0(state_, TNode<Context>{p_context}, TNode<Object>{tmp12});
    tmp14 = Undefined_0(state_);
...
TorqueStructReference_JSFunction_OR_Undefined_0 ContextSlot_ArrayFromAsyncIterableResolveContext_ArrayFromAsyncIterableResolveContext_JSFunction_OR_Undefined_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_index) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block6.is_used()) {
    ...
    tmp7 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp1}, TNode<IntPtrT>{tmp6});
    std::tie(tmp8, tmp9) = NewReference_Object_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp0}, TNode<IntPtrT>{tmp7}).Flatten();
    std::tie(tmp10, tmp11) = ReferenceCast_JSFunction_OR_Undefined_Object_0(state_, TorqueStructReference_Object_0{TNode<Union<HeapObject, TaggedIndex>>{tmp8}, TNode<IntPtrT>{tmp9}, TorqueStructUnsafe_0{}}).Flatten();
    ca_.Goto(&block10);
  }
  ...
  if (block7.is_used()) {
    ...
    ca_.Bind(&block10);
  return TorqueStructReference_JSFunction_OR_Undefined_0{TNode<Union<HeapObject, TaggedIndex>>{tmp10}, TNode<IntPtrT>{tmp11}, TorqueStructUnsafe_0{}};
}

// https://crsrc.org/c/v8/src/builtins/array-from-async.tq?l=32&c=20
TorqueStructReference_JSFunction_OR_Undefined_0 ContextSlot_ArrayFromAsyncArrayLikeResolveContext_ArrayFromAsyncArrayLikeResolveContext_JSFunction_OR_Undefined_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_index) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
