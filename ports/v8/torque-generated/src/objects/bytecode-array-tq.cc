...
class TorqueGeneratedBytecodeArrayAsserts {
  ...
  // https://crsrc.org/c/v8/src/objects/bytecode-array.tq?l=19&c=31
...
// Definition https://crsrc.org/c/v8/src/objects/bytecode-array.tq?l=26&c=1
class TorqueGeneratedBytecodeWrapperAsserts {
  // https://crsrc.org/c/v8/src/objects/bytecode-array.tq?l=28&c=3
  static constexpr int kBytecodeOffset = sizeof(StructLayout);
