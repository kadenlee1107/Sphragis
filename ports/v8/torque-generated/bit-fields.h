...
// https://crsrc.org/c/v8/src/objects/debug-objects.tq?l=70&c=1
...
#define DEFINE_TORQUE_GENERATED_MAP_BIT_FIELDS1() \
  ...
  using ReservedForMapExtensionsBit = base::BitField<bool, 7, 1, uint8_t>; \
  enum Flag: uint8_t { \
    kNone = 0, \
    ...
    kReservedForMapExtensions = uint8_t{1} << 7, \
  }; \
  using Flags = base::Flags<Flag>; \
...
// https://crsrc.org/c/v8/src/objects/templates.tq?l=37&c=1
...
// https://crsrc.org/c/v8/src/objects/templates.tq?l=109&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1099&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1103&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1138&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1144&c=1
