// Sphragis — Native M4 VM with GUI Display
...
if CommandLine.arguments.count > 1 {
    ...
    kernelPath = "\(home)/Sphragis/target/sphragis_image.bin"
}
...
let logPath = NSTemporaryDirectory() + "sphragis_gui.log"
...
window.title = "Sphragis — M4 Native VM"
window.center()
...
vm.start { result in
    switch result {
    case .success:
        print("Sphragis running on M4 silicon!")
