...
#   /mnt/d/ai/training/gguf/bat-os-coder-v2.Q4_K_M.gguf
#
# Run:
...
GGUF_OUT="$GGUF_DIR/bat-os-coder-v2.Q4_K_M.gguf"
...
"$HOME/ai-venv/bin/python" "$LLAMA_CPP/convert_hf_to_gguf.py" "$MERGED" \
    --outfile "$GGUF_DIR/bat-os-coder-v2.f16.gguf" \
    --outtype f16
...
"$LLAMA_CPP/build/bin/llama-quantize" \
    "$GGUF_DIR/bat-os-coder-v2.f16.gguf" \
    "$GGUF_OUT" \
    Q4_K_M
