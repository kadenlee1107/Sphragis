...
- **Memory safety end-to-end.** Bat_OS is written in Rust. Every transitive dependency is permissive-licensed and continuously audited against the OSV.dev vulnerability feed.
